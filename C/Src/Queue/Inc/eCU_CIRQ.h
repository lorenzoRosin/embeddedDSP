...
typedef enum
{
    e_eDSP_CIRQ_RES_OK = 0,
    e_eDSP_CIRQ_RES_BADPARAM,
    e_eDSP_CIRQ_RES_BADPOINTER,
	e_eDSP_CIRQ_RES_CORRUPTCTX,
	e_eDSP_CIRQ_RES_FULL,
    e_eDSP_CIRQ_RES_EMPTY,
    e_eDSP_CIRQ_RES_NOINITLIB,
}e_eDSP_CIRQ_RES;
 ...
 *
 * @return      e_eDSP_CIRQ_RES_BADPOINTER   - In case of bad pointer passed to the function
 *              e_eDSP_CIRQ_RES_BADPARAM     - In case of bad parameter passed to the function
 *              e_eDSP_CIRQ_RES_OK           - Circular queue initialized successfully
 */
 ...
 *
 * @return      e_eDSP_CIRQ_RES_BADPOINTER    - In case of bad pointer passed to the function
 *              e_eDSP_CIRQ_RES_OK            - Operation ended correctly
 */
 ...
 *
 * @return      e_eDSP_CIRQ_RES_BADPOINTER   - In case of bad pointer passed to the function
 *		        e_eDSP_CIRQ_RES_NOINITLIB    - Need to init the queue before taking some action
 *		        e_eDSP_CIRQ_RES_CORRUPTCTX   - In case of an corrupted context
 *              e_eDSP_CIRQ_RES_OK           - Circular queue resetted successfully
 */
 ...
 *		        e_eDSP_CIRQ_RES_NOINITLIB    - Need to init the queue before taking some action
 *		        e_eDSP_CIRQ_RES_CORRUPTCTX   - In case of an corrupted context
 *              e_eDSP_CIRQ_RES_OK           - Operation ended successfully
 */
 ...
 *		        e_eDSP_CIRQ_RES_NOINITLIB    - Need to init the queue before taking some action
 *              e_eDSP_CIRQ_RES_BADPARAM     - In case of bad parameter passed to the function
 *		        e_eDSP_CIRQ_RES_FULL         - Queue full, can't push this amount of data
 *		        e_eDSP_CIRQ_RES_CORRUPTCTX   - In case of an corrupted context
 *              e_eDSP_CIRQ_RES_OK           - Operation ended successfully
 */
 ...
 *		        e_eDSP_CIRQ_RES_NOINITLIB    - Need to init the queue before taking some action
 *              e_eDSP_CIRQ_RES_BADPARAM     - In case of bad parameter passed to the function
 *		        e_eDSP_CIRQ_RES_EMPTY        - Not so many byte present in queue
 *		        e_eDSP_CIRQ_RES_CORRUPTCTX   - In case of an corrupted context
 *              e_eDSP_CIRQ_RES_OK           - Operation ended successfully
 */
