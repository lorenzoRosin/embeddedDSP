...
static e_eDSP_HPASSFILTER_RES eDSP_HPASSFILTER_MaxCheckResToS2DP(const e_eDSP_MAXCHECK_RES p_tMaxRet);
		...
		else
		{
			...
			else
			{
				...
				else
				{
					...
					l_eRes = eDSP_HPASSFILTER_MaxCheckResToS2DP(l_eMaxRes);
