 ...
 *              e_eDSP_INTEGRAL_RES_OK             - Multiple point linearizer initialized successfully
 */
 ...
 *              e_eDSP_INTEGRAL_RES_OK           - Operation ended correctly
 */
e_eDSP_INTEGRAL_RES eDSP_INTEGRAL_CalcIntegral(t_eDSP_INTEGRAL_Ctx* const p_ptCtx, int64_t* const p_piIntegral);
